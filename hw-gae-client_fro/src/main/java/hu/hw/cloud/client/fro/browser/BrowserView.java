 ...
 *
 */
public class BrowserView<T extends BaseDto> extends Composite {
	private static Logger logger = Logger.getLogger(BrowserView.class.getName());

	interface Binder extends UiBinder<HTMLPanel, BrowserView<?>> {
	}
