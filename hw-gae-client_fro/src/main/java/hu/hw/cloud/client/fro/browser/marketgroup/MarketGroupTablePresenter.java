 ...
 *
 */
public class MarketGroupTablePresenter extends AbstractBrowserPresenter<MarketGroupDto, MarketGroupTablePresenter.MyView>
		implements MarketGroupTableUiHandlers, RefreshTableEvent.RefreshTableHandler {
	private static Logger logger = Logger.getLogger(MarketGroupTablePresenter.class.getName());

	public interface MyView extends View, HasUiHandlers<MarketGroupTableUiHandlers> {
	...
	@Inject
	MarketGroupTablePresenter(EventBus eventBus, PlaceManager placeManager, MyView view,
		...
		this.filter = filterFactory.createHotelChildFilterPresenter();
